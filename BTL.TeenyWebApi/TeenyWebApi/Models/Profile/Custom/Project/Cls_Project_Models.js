...
let Cls_Project_SQL = require('../../../../SQLFactory/Profile/Custom/Project/Cls_Project_SQL.js');


class Cls_Project_Models {

    constructor() {

        this.sqlFactory = new Cls_Project_SQL();
    }
    ...
    Fn_GetProjectAll(callback) {

        let sql = this.sqlFactory.Fn_GetProjectAll();
...
module.exports = Cls_Project_Models;
