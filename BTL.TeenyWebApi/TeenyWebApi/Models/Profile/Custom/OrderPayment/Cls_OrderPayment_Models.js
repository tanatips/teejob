...
let Cls_OrderPayment_SQL = require('../../../../SQLFactory/Profile/Custom/OrderPayment/Cls_OrderPayment_SQL.js');

class Cls_OrderPayment_Models {

    constructor() {

        this.sqlFactory = new Cls_OrderPayment_SQL();
    }
    ...
    Fn_GetOrderPaymentAll(callback) {

        let sql = this.sqlFactory.Fn_GetOrderPaymentAll();
...
module.exports = Cls_OrderPayment_Models;
