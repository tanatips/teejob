...
let Cls_JobSite_Models = require("../../../../Models/Profile/Custom/JobSite/Cls_JobSite_Models.js");
...
myGlobal.App.post('/JobSite/GetJobSiteAll', function (req, res) {
    ...
    try {
        ...
        model.Fn_GetJobSiteAll(function (resultData) {
            ...
            if (resultData.StatusOnDb === true) {
                ...
                for (var i = 0; i < resultData.ResultOnDb.length; i++) {
                    ...
                    var item = {
                        Value:resultData.ResultOnDb[i].JOBSITE_NAME,
                        Text:resultData.ResultOnDb[i].JOBSITE_NAME,
                        JOBSITE_ID: resultData.ResultOnDb[i].JOBSITE_ID,
                        JOBSITE_NAME: resultData.ResultOnDb[i].JOBSITE_NAME
                     };
