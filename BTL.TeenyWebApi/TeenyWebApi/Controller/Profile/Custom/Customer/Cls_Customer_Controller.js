...
let Cls_Customer_Models = require("../../../../Models/Profile/Custom/Customer/Cls_Customer_Models.js");
...
myGlobal.App.post('/Customer/GetCustomerAll', function (req, res) {
    ...
    try {
        ...
        model.Fn_GetCustomerAll(function (resultData) {
            ...
            if (resultData.StatusOnDb === true) {
                ...
                for (var i = 0; i < resultData.ResultOnDb.length; i++) {
                    ...
                    var item = {
                        Value:resultData.ResultOnDb[i].CUSTOMER_NAME,
                        Text:resultData.ResultOnDb[i].CUSTOMER_NAME,
                        CUSTOMER_ID: resultData.ResultOnDb[i].CUSTOMER_ID,
                        CUSTOMER_NAME: resultData.ResultOnDb[i].CUSTOMER_NAME,
                        SHORT_NAME: resultData.ResultOnDb[i].SHORT_NAME
                     };
