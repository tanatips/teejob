...
let Cls_CustomerType_Models = require("../../../../Models/Profile/Custom/CustomerType/Cls_CustomerType_Models.js");

myGlobal.App.post('/CustomerType/Search', function (req, res) {
    ...
    try {
        ...
        let model = new Cls_CustomerType_Models();
...
myGlobal.App.post('/CustomerType/Insert', function (req, res) {
...
myGlobal.App.post('/CustomerType/Update', function (req, res) {
...
myGlobal.App.post('/CustomerType/Delete', function (req, res) {
...
myGlobal.App.post('/CustomerType/GetCustomerTypeAll', function (req, res) {

    try {

        let model = new Cls_CustomerType_Models();

        model.Fn_GetCustomerTypeAll(function (resultData) {
            ...
            if (resultData.StatusOnDb === true) {
                ...
                for (var i = 0; i < resultData.ResultOnDb.length; i++) {
                    ...
                    var item = {
                        Value: resultData.ResultOnDb[i].CUSTOMER_TYPE_NAME,
                        Text: resultData.ResultOnDb[i].CUSTOMER_TYPE_NAME,
                        CUSTOMER_TYPE_ID: resultData.ResultOnDb[i].CUSTOMER_TYPE_ID,
                        CUSTOMER_TYPE_NAME: resultData.ResultOnDb[i].CUSTOMER_TYPE_NAME
                    };
