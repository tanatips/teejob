...
let Cls_OrderPayment_Models = require("../../../../Models/Profile/Custom/OrderPayment/Cls_OrderPayment_Models.js");

myGlobal.App.post('/OrderPayment/Search', function (req, res) {
    ...
    try {
        ...
        let model = new Cls_OrderPayment_Models();
        ...
        model.Fn_Search(dataItem, function (resultData) {
            ...
            if (resultData.StatusOnDb === true) {
                ...
                for (var i = 0; i < resultData.ResultOnDb.length; i++) {
                    ...
                    var item = {
                        No: (i + 1).toString(),
                        ORDER_PAYMENT_ID: resultData.ResultOnDb[i].ORDER_PAYMENT_ID,
                        ORDER_PAYMENT_NAME: resultData.ResultOnDb[i].ORDER_PAYMENT_NAME,
...
myGlobal.App.post('/OrderPayment/Insert', function (req, res) {
...
myGlobal.App.post('/OrderPayment/Update', function (req, res) {
...
myGlobal.App.post('/OrderPayment/Delete', function (req, res) {
...
myGlobal.App.post('/OrderPayment/GetOrderPaymentAll', function (req, res) {

    try {

        let model = new Cls_OrderPayment_Models();

        model.Fn_GetOrderPaymentAll(function (resultData) {
            ...
            if (resultData.StatusOnDb === true) {
                ...
                for (var i = 0; i < resultData.ResultOnDb.length; i++) {
                    ...
                    var item = {
                        Value: resultData.ResultOnDb[i].ORDER_PAYMENT_NAME,
                        Text: resultData.ResultOnDb[i].ORDER_PAYMENT_NAME,
                        ORDER_PAYMENT_ID: resultData.ResultOnDb[i].ORDER_PAYMENT_ID,
                        ORDER_PAYMENT_NAME: resultData.ResultOnDb[i].ORDER_PAYMENT_NAME
                    };
