...
let Cls_Product_Models = require("../../../../../Models/Profile/Companied/Factory/Product/Cls_Product_Models.js");
...
myGlobal.App.post('/Product/GetProductAll', function (req, res) {

    try {

        let model = new Cls_Product_Models();

        model.Fn_GetProductAll(function (resultData) {
            ...
            if (resultData.StatusOnDb === true) {
                ...
                for (var i = 0; i < resultData.ResultOnDb.length; i++) {
                    ...
                    var item = {
                        Value:resultData.ResultOnDb[i].PRODUCT_NAME,
                        Text:resultData.ResultOnDb[i].PRODUCT_NAME,
                        PRODUCT_ID: resultData.ResultOnDb[i].PRODUCT_ID,
                        PRODUCT_NAME: resultData.ResultOnDb[i].PRODUCT_NAME
                     };
...
myGlobal.App.post('/Product/GetProductByProductGroup', function (req, res) {
    ...
    try {
        ...
        model.Fn_GetProductnByProductGroup(dataItem, function (resultData) {
