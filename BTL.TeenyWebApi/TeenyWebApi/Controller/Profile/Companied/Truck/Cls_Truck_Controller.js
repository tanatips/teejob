...
let Cls_Truck_Models = require("../../../../Models/Profile/Companied/Truck/Cls_Truck_Models.js");


myGlobal.App.post('/Truck/Search', function (req, res) {
    ...
    try {
        ...
        let model = new Cls_Truck_Models();
            ...
            if (resultData.StatusOnDb === true) {
                ...
                for (var i = 0; i < resultData.ResultOnDb.length; i++) {
                    ...
                    var item = {
                        ...
                        TRUCK_NAME: resultData.ResultOnDb[i].TRUCK_NAME,
                        TRUCK_SIZE: resultData.ResultOnDb[i].TRUCK_SIZE,
                        TRUCK_CAPACITY: resultData.ResultOnDb[i].TRUCK_CAPACITY,
                        CAPACITY_UNIT: resultData.ResultOnDb[i].CAPACITY_UNIT,
...
myGlobal.App.post('/Truck/Insert', function (req, res) {
...
myGlobal.App.post('/Truck/Update', function (req, res) {
...
myGlobal.App.post('/Truck/Delete', function (req, res) {
...
myGlobal.App.post('/Truck/GetTruckAll', function (req, res) {

    try {

        let model = new Cls_Truck_Models();

        model.Fn_GetTruckAll(function (resultData) {
            ...
            if (resultData.StatusOnDb === true) {
                ...
                for (var i = 0; i < resultData.ResultOnDb.length; i++) {
                    ...
                    var item = {
                        Value:resultData.ResultOnDb[i].TRUCK_NO,
                        Text:resultData.ResultOnDb[i].TRUCK_NO,
                        TRUCK_ID: resultData.ResultOnDb[i].TRUCK_ID,
                        TRUCK_NO: resultData.ResultOnDb[i].TRUCK_NO,
                        TRUCK_NAME: resultData.ResultOnDb[i].TRUCK_NAME
                     };
...
myGlobal.App.post('/Truck/GetTruckByPlant', function (req, res) {
    ...
    try {
        ...
        model.Fn_GetTruckByPlant(dataItem, function (resultData) {
