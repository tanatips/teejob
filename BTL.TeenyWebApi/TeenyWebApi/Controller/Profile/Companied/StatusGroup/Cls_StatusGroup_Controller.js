...
let Cls_StatusGroup_Models = require("../../../../Models/Profile/Companied/StatusGroup/Cls_StatusGroup_Models.js");
...
myGlobal.App.post('/StatusGroup/GetStatusGroupAll', function (req, res) {
    ...
    try {
        ...
        model.Fn_GetStatusGroupAll(function (resultData) {
            ...
            if (resultData.StatusOnDb === true) {
                ...
                for (var i = 0; i < resultData.ResultOnDb.length; i++) {
                    ...
                    var item = {
                        Value: resultData.ResultOnDb[i].STATUS_GROUP_NAME,
                        Text: resultData.ResultOnDb[i].STATUS_GROUP_NAME,
                        STATUS_GROUP_ID: resultData.ResultOnDb[i].STATUS_GROUP_ID,
                        STATUS_GROUP_NAME: resultData.ResultOnDb[i].STATUS_GROUP_NAME
                     };
