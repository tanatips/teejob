    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/Manufacture/Search";
            ...
            case "External":
                ...
                dataItem = {
                    TOKEN: item.token,
                    STORY: item.STORY,
                    ACTION: "Manufacture/Search",
                    ACTION_RETURN: "Return/Manufacture/Search",
                    WEBAPI_ACTION: "/Manufacture/Search",
...
myGlobal.App.post('/Manufacture/Insert', function (req, res) {
    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/Manufacture/Insert";
            ...
            case "External":
                ...
                dataItem = {
                    TOKEN: item.token,
                    STORY: item.STORY,
                    ACTION: "Manufacture/Insert",
                    ACTION_RETURN: "Return/Manufacture/Insert",
                    WEBAPI_ACTION: "/Manufacture/Insert",
                    TOPPIC_RETURN: myGlobal.ItemConfig.MY_TOPPIC[0].TOPPIC_NAME,
                    FORM: {
                        data: JSON.stringify(req.body)
                    }
...
myGlobal.App.post('/Manufacture/Update', function (req, res) {
    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/Manufacture/Update";
            ...
            case "External":
                ...
                dataItem = {
                    TOKEN: item.token,
                    STORY: item.STORY,
                    ACTION: "Manufacture/Update",
                    ACTION_RETURN: "Return/Manufacture/Update",
                    WEBAPI_ACTION: "/Manufacture/Update",
                    TOPPIC_RETURN: myGlobal.ItemConfig.MY_TOPPIC[0].TOPPIC_NAME,
                    FORM: {
                        data: JSON.stringify(req.body)
                    }
...
myGlobal.App.post('/Manufacture/Delete', function (req, res) {
    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/Manufacture/Delete";
            ...
            case "External":
                ...
                dataItem = {
                    TOKEN: item.token,
                    STORY: item.STORY,
                    ACTION: "Manufacture/Delete",
                    ACTION_RETURN: "Return/Manufacture/Delete",
                    WEBAPI_ACTION: "/Manufacture/Delete",
                    TOPPIC_RETURN: myGlobal.ItemConfig.MY_TOPPIC[0].TOPPIC_NAME,
                    FORM: {
                        data: JSON.stringify(req.body)
                    }
