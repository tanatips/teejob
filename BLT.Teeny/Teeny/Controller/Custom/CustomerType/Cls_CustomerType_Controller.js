...
let Cls_CustomerType_Models = require("../../../Models/Custom/CustomerType/Cls_CustomerType_Models.js");
    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/CustomerType/GetCustomerTypeAll";
            ...
            case "External":
                ...
                dataItem = {
                    TOKEN: item.token,
                    STORY: item.STORY,
                    ACTION: "CustomerType/GetCustomerTypeAll",
                    ACTION_RETURN: "Return/CustomerType/GetCustomerTypeAll",
                    WEBAPI_ACTION: "/CustomerType/GetCustomerTypeAll",
