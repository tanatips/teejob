...
let Cls_OrderPayment_Models = require("../../../Models/Custom/OrderPayment/Cls_OrderPayment_Models.js");
    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/OrderPayment/GetOrderPaymentAll";
            ...
            case "External":
                ...
                dataItem = {
                    TOKEN: item.token,
                    STORY: item.STORY,
                    ACTION: "OrderPayment/GetOrderPaymentAll",
                    ACTION_RETURN: "Return/OrderPayment/GetOrderPaymentAll",
                    WEBAPI_ACTION: "/OrderPayment/GetOrderPaymentAll",
