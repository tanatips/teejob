    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/PlantMaterial/Insert";
            ...
            case "External":
                ...
                dataItem = {
                    TOKEN: item.token,
                    STORY: item.STORY,
                    ACTION: "PlantMaterial/Insert",
                    ACTION_RETURN: "Return/PlantMaterial/Insert",
                    WEBAPI_ACTION: "/PlantMaterial/Insert",
    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/PlantMaterial/Update";
            ...
            case "External":
                ...
                dataItem = {
                    TOKEN: item.token,
                    STORY: item.STORY,
                    ACTION: "PlantMaterial/Update",
                    ACTION_RETURN: "Return/PlantMaterial/Update",
                    WEBAPI_ACTION: "/PlantMaterial/Update",
                    TOPPIC_RETURN: myGlobal.ItemConfig.MY_TOPPIC[0].TOPPIC_NAME,
                    FORM: {
                        data: JSON.stringify(req.body)
                    }
    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/PlantMaterial/Delete";
            ...
            case "External":
                ...
                dataItem = {
                    TOKEN: item.token,
                    STORY: item.STORY,
                    ACTION: "PlantMaterial/Delete",
                    ACTION_RETURN: "Return/PlantMaterial/Delete",
                    WEBAPI_ACTION: "/PlantMaterial/Delete",
                    TOPPIC_RETURN: myGlobal.ItemConfig.MY_TOPPIC[0].TOPPIC_NAME,
                    FORM: {
                        data: JSON.stringify(req.body)
                    }
    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/PlantMaterial/PlantHaveMaterial";
            ...
            case "External":
                ...
                dataItem = {
                    TOKEN: item.token,
                    STORY: item.STORY,
                    ACTION: "PlantMaterial/PlantHaveMaterial",
                    ACTION_RETURN: "Return/PlantMaterial/PlantHaveMaterial",
                    WEBAPI_ACTION: "/PlantMaterial/PlantHaveMaterial",
                    TOPPIC_RETURN: myGlobal.ItemConfig.MY_TOPPIC[0].TOPPIC_NAME,
                    FORM: {
                        data: JSON.stringify(req.body)
                    }
