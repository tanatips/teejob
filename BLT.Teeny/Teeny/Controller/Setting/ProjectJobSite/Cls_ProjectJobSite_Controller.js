    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/ProjectJobSite/Insert";
            ...
            case "External":
                ...
                dataItem = {
                    TOKEN: item.token,
                    STORY: item.STORY,
                    ACTION: "ProjectJobSite/Insert",
                    ACTION_RETURN: "Return/ProjectJobSite/Insert",
                    WEBAPI_ACTION: "/ProjectJobSite/Insert",
    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/ProjectJobSite/Update";
            ...
            case "External":
                ...
                dataItem = {
                    TOKEN: item.token,
                    STORY: item.STORY,
                    ACTION: "ProjectJobSite/Update",
                    ACTION_RETURN: "Return/ProjectJobSite/Update",
                    WEBAPI_ACTION: "/ProjectJobSite/Update",
                    TOPPIC_RETURN: myGlobal.ItemConfig.MY_TOPPIC[0].TOPPIC_NAME,
                    FORM: {
                        data: JSON.stringify(req.body)
                    }
    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/ProjectJobSite/Delete";
            ...
            case "External":
                ...
                dataItem = {
                    TOKEN: item.token,
                    STORY: item.STORY,
                    ACTION: "ProjectJobSite/Delete",
                    ACTION_RETURN: "Return/ProjectJobSite/Delete",
                    WEBAPI_ACTION: "/ProjectJobSite/Delete",
                    TOPPIC_RETURN: myGlobal.ItemConfig.MY_TOPPIC[0].TOPPIC_NAME,
                    FORM: {
                        data: JSON.stringify(req.body)
                    }
    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/ProjectJobSite/ProjectHaveJobSite";
            ...
            case "External":
                ...
                dataItem = {
                    TOKEN: item.token,
                    STORY: item.STORY,
                    ACTION: "ProjectJobSite/ProjectHaveJobSite",
                    ACTION_RETURN: "Return/ProjectJobSite/ProjectHaveJobSite",
                    WEBAPI_ACTION: "/ProjectJobSite/ProjectHaveJobSite",
                    TOPPIC_RETURN: myGlobal.ItemConfig.MY_TOPPIC[0].TOPPIC_NAME,
                    FORM: {
                        data: JSON.stringify(req.body)
                    }
