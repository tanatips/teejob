...
let Cls_Material_Models = require("../../../../Models/Companied/Store/Material/Cls_Material_Models.js");
    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/Material/Search";
            ...
            case "External":
                ...
                dataItem = {
                    ...
                    ACTION_RETURN: "Return/Material/Search",
                    WEBAPI_ACTION: "/Material/Search",
    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/Material/Insert";
            ...
            case "External":
                ...
                dataItem = {
                    TOKEN: item.token,
                    STORY: item.STORY,
                    ACTION: "Material/Insert",
                    ACTION_RETURN: "Return/Material/Insert",
                    WEBAPI_ACTION: "/Material/Insert",
                    TOPPIC_RETURN: myGlobal.ItemConfig.MY_TOPPIC[0].TOPPIC_NAME,
                    FORM: {
                        data: JSON.stringify(req.body)
                    }
    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/Material/Update";
            ...
            case "External":
                ...
                dataItem = {
                    ...
                    ACTION_RETURN: "Return/Material/Update",
                    WEBAPI_ACTION: "/Material/Update",
                    TOPPIC_RETURN: myGlobal.ItemConfig.MY_TOPPIC[0].TOPPIC_NAME,
                    FORM: {
                        data: JSON.stringify(req.body)
                    }
    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/Material/Delete";
            ...
            case "External":
                ...
                dataItem = {
                    ...
                    ACTION_RETURN: "Return/Material/Delete",
                    WEBAPI_ACTION: "/Material/Delete",
                    TOPPIC_RETURN: myGlobal.ItemConfig.MY_TOPPIC[0].TOPPIC_NAME,
                    FORM: {
                        data: JSON.stringify(req.body)
                    }
    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/Material/GetMaterialAll";
            ...
            case "External":
                ...
                dataItem = {
                    TOKEN: item.token,
                    STORY: item.STORY,
                    ACTION: "Material/GetMaterialAll",
                    ACTION_RETURN: "Return/Material/GetMaterialAll",
                    WEBAPI_ACTION: "/Material/GetMaterialAll",
                    TOPPIC_RETURN: myGlobal.ItemConfig.MY_TOPPIC[0].TOPPIC_NAME,
                    FORM: {
                        data: JSON.stringify(req.body)
                    }
    ...
    try {
        ...
        switch (dataItem.ModeRun) {
            ...
            case "Internal":
                ...
                let urlWebApi = myGlobal.ItemConfig.WEB_API.URL + "/Material/GetMaterialByMaterialType";
            ...
            case "External":
                ...
                dataItem = {
                    TOKEN: item.token,
                    STORY: item.STORY,
                    ACTION: "Material/GetMaterialByMaterialType",
                    ACTION_RETURN: "Return/Material/GetMaterialByMaterialType",
                    WEBAPI_ACTION: "/Material/GetMaterialByMaterialType",
                    TOPPIC_RETURN: myGlobal.ItemConfig.MY_TOPPIC[0].TOPPIC_NAME,
                    FORM: {
                        data: JSON.stringify(req.body)
                    }
