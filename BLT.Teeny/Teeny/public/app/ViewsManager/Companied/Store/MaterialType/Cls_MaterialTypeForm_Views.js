...
function Cls_MaterialTypeForm_Views(urlRoot) {
       
    var materialTypeAction = new Cls_MaterialTypeAction_Views(urlRoot);
    ...
    this.Fn_RenderContentSearch = function () {
        ...
        var panel = Ext.create('Ext.form.Panel', {
            ...
            items: [{
                ...
                items: [{
                    xtype: 'textfield',
                    id: 'id-txtMaterialTypeName-MaterialTypePage',                    
                    width: '70%',
                    labelWidth: 120,
                    fieldLabel: 'Material Type Name'
                }]
            }]
    ...
    this.Fn_ShowGrid = function () {
        ...
        var myStore = Ext.create('Ext.data.Store', {
            id: 'id-storeMaterialType-MaterialTypePage',
            pageSize: limitPage,
            autoLoad: false,
            autoDestory: true,
            fields: [
            ...
            proxy: {
                type: 'ajax',
                url: urlRoot + "/MaterialType/Search",
                actionMethods: {
                    create : 'POST',
                    read   : 'POST',
                    update : 'POST',
        ...
        var myGrid = Ext.create('Ext.grid.Panel', {
            id: 'id-GridMaterialType-MaterialTypePage',
            autoDestory: true,
            store: myStore,
            // title: 'Province List',
    ...
    //            }
            ...
            columns: [
                                ...
                                Ext.MessageBox.show({
                                    ...
                                    fn: function (btn, text) {                                        
                                        if (btn === 'yes') {
                                            ...
                                            materialTypeAction.Fn_Delete(rec);
                                        }
                                    }
                                });
                ...
                { header: 'Material Type Name', width: 400, sortable: true, hidden: false, dataIndex: 'MATERIAL_TYPE_NAME' },
            ...
            bbar: Ext.create('Ext.PagingToolbar', {
                id: 'id-Pagingbar-MaterialTypePage',
                store: myStore,
                pageSize: limitPage,
                displayInfo: true,
                listeners: {
                    beforechange: function (paging, params) {
                        ...
                        myStore.getProxy().getExtraParams().MATERIAL_TYPE_NAME = Ext.getCmp('id-txtMaterialTypeName-MaterialTypePage').getValue();
    ...
    var Fn_PopupWindowNewEdit = function (event, rec) {
        var myWin = Ext.create('Ext.Window', {
            id: 'id-windowMaterialType-MaterialTypePage',
            title: event + ' Material Type',
            region: 'center',
            ...
            listeners: {
                afterrender: function (panel) {
                    ...
                    if (event === "Edit") {
                        Ext.getCmp('id-txtMaterialTypeName-NewEdit-MaterialTypePage').setValue(rec.data.MATERIAL_TYPE_NAME);
                        Ext.getCmp('id-txtDescription-NewEdit-MaterialTypePage').setValue(rec.data.DESCRIPTION);
                    }
                }
            },
            items: [{
                xtype: 'textfield',
                id: 'id-txtMaterialTypeName-NewEdit-MaterialTypePage',
                width: 600,
                labelWidth: 120,
                margin: '1 1 1 1',
                ...
                xtype: 'textareafield',
                id: 'id-txtDescription-NewEdit-MaterialTypePage',
                maxRows: 3,
                width: 600,
                labelWidth: 120,
                margin: '1 1 1 1',
                        ...
                        fn: function (btn, text) {
                            ...
                            if (btn === 'yes') {
                                if (event === "New") {
                                     ...
                                     materialTypeAction.Fn_Insert(myWin);
                                }
                                else {
                                     materialTypeAction.Fn_Update(myWin, rec);
                                }
                            }
                        }
                    });
