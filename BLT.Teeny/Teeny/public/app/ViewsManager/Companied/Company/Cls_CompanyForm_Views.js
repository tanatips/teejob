...
function Cls_CompanyForm_Views(urlRoot) {
       
    var companyAction = new Cls_CompanyAction_Views(urlRoot);
    ...
    this.Fn_RenderContentSearch = function () {
        ...
        var panel = Ext.create('Ext.form.Panel', {
            ...
            items: [{
                ...
                items: [{
                    xtype: 'textfield',
                    id: 'id-txtCompanyName-CompanyPage',
                    width: '70%',
                    labelWidth: 100,
                ...
                items: [{
                    xtype: 'textfield',
                    id: 'id-txtShortName-CompanyPage',
                    width: '70%',
                    labelWidth: 100,
    ...
    this.Fn_ShowGrid = function () {
        ...
        var myStore = Ext.create('Ext.data.Store', {
            id: 'id-storeCompany-CompanyPage',
            pageSize: limitPage,
            autoLoad: false,
            autoDestory: true,
            fields: [
            ...
            bbar: Ext.create('Ext.PagingToolbar', {
                ...
                listeners: {
                    beforechange: function (paging, params) {
                        ...
                        myStore.getProxy().getExtraParams().COMPANY_NAME = Ext.getCmp('id-txtCompanyName-CompanyPage').getValue();
    ...
    var Fn_PopupWindowNewEdit = function (event, rec) {
        var myWin = Ext.create('Ext.Window', {
            id: 'id-windowCompany-CompanyPage',
            title: event + ' Company',
            region: 'center',
            ...
            listeners: {
                afterrender: function (panel) {
                    ...
                    if (event === "Edit") {
                        Ext.getCmp('id-txtCompanyName-NewEdit-CompanyPage').setValue(rec.data.COMPANY_NAME);
                        Ext.getCmp('id-txtShortName-NewEdit-CompanyPage').setValue(rec.data.SHORT_NAME);
                        Ext.getCmp('id-txtAddress-NewEdit-CompanyPage').setValue(rec.data.ADDRESS);
                        Ext.getCmp('id-txtPhoneNo-NewEdit-CompanyPage').setValue(rec.data.PHONE_NO);
                        Ext.getCmp('id-txtMobileNo-NewEdit-CompanyPage').setValue(rec.data.MOBILE_NO);
                        Ext.getCmp('id-txtFaxNo-NewEdit-CompanyPage').setValue(rec.data.FAX_NO);
                        Ext.getCmp('id-txtDescription-NewEdit-CompanyPage').setValue(rec.data.DESCRIPTION);
                    }
                }
            },
            items: [{
                xtype: 'textfield',
                id: 'id-txtCompanyName-NewEdit-CompanyPage',
                width: 600,
                labelWidth: 120,
                margin: '1 1 1 1',
                fieldLabel: 'Company Name'
                ...
                xtype: 'textfield',
                id: 'id-txtShortName-NewEdit-CompanyPage',
                width: 300,
                labelWidth: 120,
                margin: '1 1 1 1',
                fieldLabel: 'Short Name'
                ...
                xtype: 'textfield',
                id: 'id-txtPhoneNo-NewEdit-CompanyPage',
                width: 400,
                labelWidth: 120,
                margin: '1 1 1 1',
                fieldLabel: 'Phone No'
                ...
                xtype: 'textfield',
                id: 'id-txtMobileNo-NewEdit-CompanyPage',
                width: 400,
                labelWidth: 120,
                margin: '1 1 1 1',
                ...
                xtype: 'textfield',
                id: 'id-txtFaxNo-NewEdit-CompanyPage',
                width: 400,
                labelWidth: 120,
                margin: '1 1 1 1',
                fieldLabel: 'Fax No'
                ...
                xtype: 'textareafield',
                id: 'id-txtAddress-NewEdit-CompanyPage',
                maxRows: 3,
                width: 600,
                labelWidth: 120,
                margin: '1 1 1 1',
                ...
                xtype: 'textareafield',
                id: 'id-txtDescription-NewEdit-CompanyPage',
                maxRows: 3,
                width: 600,
                labelWidth: 120,
                margin: '1 1 1 1',
                        ...
                        fn: function (btn, text) {
                            ...
                            if (btn === 'yes') {
                                if (event === "New") {
                                     ...
                                     companyAction.Fn_Insert(myWin);
                                }
                                else {
                                     companyAction.Fn_Update(myWin, rec);
                                }
                            }
                        }
                    });
