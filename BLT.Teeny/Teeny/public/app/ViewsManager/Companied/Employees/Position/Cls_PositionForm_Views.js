...
function Cls_PositionForm_Views(urlRoot) {
       
    var positionAction = new Cls_PositionAction_Views(urlRoot);
    ...
    this.Fn_RenderContentSearch = function () {
        ...
        var panel = Ext.create('Ext.form.Panel', {
            ...
            items: [{
                ...
                items: commonUI.Fn_CreateComboBoxOnFormPanel('/Department/GetDepartmentAll', 'id-ComboDepartmentName-PositionPage', 'Department Name', 120, 450)
                ...
                items: [{
                    xtype: 'textfield',
                    id: 'id-txtPositionName-PositionPage',                    
                    width: '70%',
                    labelWidth: 120,
    ...
    this.Fn_ShowGrid = function () {
        ...
        var myStore = Ext.create('Ext.data.Store', {
            id: 'id-storePosition-PositionPage',
            pageSize: limitPage,
            autoLoad: false,
            autoDestory: true,
            fields: [
        ...
        var myGrid = Ext.create('Ext.grid.Panel', {
            id: 'id-GridPosition-PositionPage',
            autoDestory: true,
            store: myStore,
            // title: 'Province List',
            ...
            columns: [
                ...
                { header: 'Position Name', width: 300, sortable: true, hidden: false, dataIndex: 'POSITION_NAME' },
            ...
            bbar: Ext.create('Ext.PagingToolbar', {
                id: 'id-Pagingbar-PositionPage',
                store: myStore,
                pageSize: limitPage,
                displayInfo: true,
                listeners: {
                    beforechange: function (paging, params) {
                        myStore.getProxy().getExtraParams().DEPARTMENT_NAME = Ext.getCmp('id-ComboDepartmentName-PositionPage').getValue();
                        myStore.getProxy().getExtraParams().POSITION_NAME = Ext.getCmp('id-txtPositionName-PositionPage').getValue();
    ...
    var Fn_PopupWindowNewEdit = function (event, rec) {
        var myWin = Ext.create('Ext.Window', {
            id: 'id-windowPosition-PositionPage',
            title: event + ' Position',
            region: 'center',
            width: Ext.getBody().getViewSize().width - 690,
            height: Ext.getBody().getViewSize().height - 370,
            ...
            listeners: {
                afterrender: function (panel) {
                    ...
                    if (event === "Edit") {
                        ...
                        Ext.getCmp('id-ComboDepartmentName-NewEdit-PositionPage').setValue(rec.data.DEPARTMENT_NAME);
                        Ext.getCmp('id-txtPositionName-NewEdit-PositionPage').setValue(rec.data.POSITION_NAME);                      
                        Ext.getCmp('id-txtDescription-NewEdit-PositionPage').setValue(rec.data.DESCRIPTION);
                    }
                }
            },
            items: [{
                ...
                items: commonUI.Fn_CreateComboBoxOnFormPanel('/Department/GetDepartmentAll', 'id-ComboDepartmentName-NewEdit-PositionPage', 'Department Name', 120, 450)

            }, {
                xtype: 'textfield',
                id: 'id-txtPositionName-NewEdit-PositionPage',
                width: 600,
                labelWidth: 120,
                margin: '1 1 1 1',
                fieldLabel: 'Position Name'
                ...
                xtype: 'textareafield',
                id: 'id-txtDescription-NewEdit-PositionPage',
                maxRows: 3,
                width: 600,
                labelWidth: 120,
                margin: '1 1 1 1',
                        ...
                        fn: function (btn, text) {
                            ...
                            if (btn === 'yes') {
                                if (event === "New") {
                                    ...
                                    positionAction.Fn_Insert(myWin);
                                }
                                else {
                                    positionAction.Fn_Update(myWin, rec);
                                }
                            }
                        }
                    });
