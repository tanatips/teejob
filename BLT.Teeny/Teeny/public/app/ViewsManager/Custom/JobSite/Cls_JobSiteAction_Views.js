...
function Cls_JobSiteAction_Views(urlRoot) {
    ...
    var Fn_ReloadGrid = function () {
        ...
        Ext.getCmp('id-GridJobSite-JobSitePage').store.reload({
            url: urlRoot + "/JobSite/Search",
            params: {
                JOBSITE_NAME: Ext.getCmp('id-txtJobSiteName-JobSitePage').getValue(),               
                ModeRun: modeRun
            },
        ...
        //=============================================================//
       // Ext.getCmp('id-Pagingbar-JobSitePage').moveFirst();
    };
    ...
    this.Fn_Insert = function (myWin) {
        ...
        var ajaxObj = $.ajax({
            url: urlRoot + "/JobSite/Insert",
            data: {    
                ModeRun: modeRun,
                JOBSITE_NAME: Ext.getCmp('id-txtJobSiteName-NewEdit-JobSitePage').getValue(),               
                DESCRIPTION: Ext.getCmp('id-txtDescription-NewEdit-JobSitePage').getValue(),
