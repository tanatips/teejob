...
function Cls_ProjectForm_Views(urlRoot) {
       
    var projectAction = new Cls_ProjectAction_Views(urlRoot);
    ...
    this.Fn_RenderContentSearch = function () {
        ...
        var panel = Ext.create('Ext.form.Panel', {
            ...
            items: [{
                ...
                items: [{
                    xtype: 'textfield',
                    id: 'id-txtProjectName-ProjectPage',                    
                    width: '70%',
                    labelWidth: 120,
    ...
    this.Fn_ShowGrid = function () {
        ...
        var myStore = Ext.create('Ext.data.Store', {
            id: 'id-storeProject-ProjectPage',
            pageSize: limitPage,
            autoLoad: false,
            autoDestory: true,
            fields: [
    ...
    //            }
            ...
            columns: [
                ...
                { header: 'Project Name', width: 400, sortable: true, hidden: false, dataIndex: 'PROJECT_NAME' },
            ...
            bbar: Ext.create('Ext.PagingToolbar', {
                ...
                listeners: {
                    beforechange: function (paging, params) {
                        ...
                        myStore.getProxy().getExtraParams().PROJECT_NAME = Ext.getCmp('id-txtProjectName-ProjectPage').getValue();
    ...
    var Fn_PopupWindowNewEdit = function (event, rec) {
        var myWin = Ext.create('Ext.Window', {
            id: 'id-windowProject-ProjectPage',
            title: event + ' Project',
            region: 'center',
            ...
            listeners: {
                afterrender: function (panel) {
                    ...
                    if (event === "Edit") {
                        Ext.getCmp('id-txtProjectName-NewEdit-ProjectPage').setValue(rec.data.PROJECT_NAME);
                        Ext.getCmp('id-txtDescription-NewEdit-ProjectPage').setValue(rec.data.DESCRIPTION);
                    }
                }
            },
            items: [{
                xtype: 'textfield',
                id: 'id-txtProjectName-NewEdit-ProjectPage',
                width: 600,
                labelWidth: 120,
                margin: '1 1 1 1',
                fieldLabel: 'Project Name'
                ...
                xtype: 'textareafield',
                id: 'id-txtDescription-NewEdit-ProjectPage',
                maxRows: 3,
                width: 600,
                labelWidth: 120,
                margin: '1 1 1 1',
                        ...
                        fn: function (btn, text) {
                            ...
                            if (btn === 'yes') {
                                if (event === "New") {
                                    ...
                                    projectAction.Fn_Insert(myWin);
                                }
                                else {
                                     projectAction.Fn_Update(myWin, rec);
                                }
                            }
                        }
                    });
