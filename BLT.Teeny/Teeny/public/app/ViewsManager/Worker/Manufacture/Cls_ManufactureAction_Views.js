...
function Cls_ManufactureAction_Views(urlRoot) {
        
    var msgBox= new Cls_MessageBox_Views();
    
    //--- 1.Search -----------------------------------------------------//
    this.Fn_Search = function () {                         
        Fn_ReloadTreeOrderProduct();
    };

    var Fn_ReloadTreeOrderProduct = function () {

        Ext.getCmp('id-TreeOrderProduct-ManufacturePage').store.load({
            url: urlRoot + "/Manufacture/Search",
            params: {
                ORDER_NO: Ext.getCmp('id-txtOrderNo-ManufacturePage').getValue(),                
                STATUS_NAME: Ext.getCmp('id-ComboStatusName-ManufacturePage').getValue(),
                ModeRun: modeRun
            },
            callback: function () {
